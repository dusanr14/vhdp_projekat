...
HD_PWD='C:/Users/Dusan/Desktop/8_semestar/system_level/doPivoting/doPivoting.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_pivot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_pivot.tcl
